...
exports.checkForUpdates = () => {
  if (
    ...
    return exports
      .request("https://api.github.com/repos/lazymak3r/ytdl-core/contents/package.json", {
        requestOptions: {
          headers: {
            "User-Agent":
      ...
      .then(
        response => {
          ...
          if (pkgFile.version !== pkg.version && updateWarnTimes++ < 5) {
            ...
            console.warn(
              '\x1b[33mWARNING:\x1B[0m lazymak3r-ytdl-core is out of date! Update with "npm install @lazymak3r/ytdl-core@latest".',
            );
          }
        },
        err => {
      ...
      if (oldCookieWarning) {
        ...
        console.warn(
          "\x1b[33mWARNING:\x1B[0m Using old cookie format, " +
            "please use the new one instead. (https://github.com/lazymak3r/ytdl-core#cookies-support)",
        );
      }
    }
    if (options.requestOptions.dispatcher && oldDispatcherWarning) {
      ...
      console.warn(
        "\x1b[33mWARNING:\x1B[0m Your dispatcher is overridden by `ytdl.Agent`. " +
          ...
          "(https://github.com/lazymak3r/ytdl-core#how-to-implement-ytdlagent-with-your-own-dispatcher)",
      );
    }
  ...
  if (oldLocalAddressWarning) {
    ...
    console.warn(
      "\x1b[33mWARNING:\x1B[0m Using old localAddress option, " +
        "please add it to the agent options instead. (https://github.com/lazymak3r/ytdl-core#ip-rotation)",
    );
  }
};
    ...
    if (oldIpRotationsWarning) {
      ...
      console.warn(
        "\x1b[33mWARNING:\x1B[0m IPv6Block option is deprecated, " +
          "please create your own ip rotation instead. (https://github.com/lazymak3r/ytdl-core#ip-rotation)",
      );
    }
  }
};
