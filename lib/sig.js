...
const DECIPHER_FUNC_NAME = "Lazymak3rDecipherFunc";
    ...
    console.warn(
      "\x1b[33mWARNING:\x1B[0m Could not parse decipher function.\n" +
        ...
        `Please report this issue with the "${utils.saveDebugFile(
          "base.js",
          body,
        )}" file on https://github.com/lazymak3r/ytdl-core/issues/144.`,
    );
...
const N_TRANSFORM_FUNC_NAME = "Lazymak3rNTransformFunc";
